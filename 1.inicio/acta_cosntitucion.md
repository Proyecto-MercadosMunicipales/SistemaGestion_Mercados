...
*   **Objetivos Específicos:**
    ...
    2. Digitalizar el cobro de tarifas diarias/mensuales y la emisión de reportes financieros.
...
*   **Módulo de Cobros:** Pasarela administrativa para registrar el pago de patentes, multas y tarifas de mantenimiento con histórico auditable.
*   **Módulo de Licencias Sanitarias:** Registro, alertas de vencimiento y control documental de los requisitos de sanidad de los comerciantes.
*   **Módulo de Reportes:** Panel de control de KPIs e informes automáticos mensuales para la Dirección de Ingresos.
...
*   **Supuestos Clave:**
    *   La normativa municipal sobre licencias sanitarias y cobros se mantendrá estable durante el periodo de desarrollo.
    *   El equipo técnico asignado inicialmente (incluyendo desarrolladores clave) permanecerá en el proyecto hasta el cierre del MVP.
...
*   **Recursos Humanos Iniciales:** 
    ...
    *   1 Desarrolladores Senior
    *   2 Desarrolladores Mid-Level/Junior
    *   1 Analista de Calidad (QA)
    *   1 Documentador
